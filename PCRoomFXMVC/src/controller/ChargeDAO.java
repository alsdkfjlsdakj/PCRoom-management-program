...
public String getLoginUserSeatNo(String userId) {
	...
	// 아이디를 받아서 추가충전하는 순간의 남은 시간을 저장한다.
//	public void saveRemainTime(int remainTime, int enterNo) {
//		// ② 데이터 처리를 위한 SQL 문
//		String dml = "update chargeTbl set userAvailableTime = ?" // 원래 있던 금액에 추가금 더하기
//				+ " where enterNo = ?";
//
//		Connection con = null;
//		PreparedStatement pstmt = null;
...
//
//			if (i == 1) {
//				CommonFunc.alertDisplay(1, "요금 충전", cvo.getUserId() + "님 요금 충전 완료", "시간이 충전되었습니다.");
//			} else {
//				CommonFunc.alertDisplay(1, "요금 충전", "오류", "요금 정보 수정을 실패하였습니다.");
//			}
//
